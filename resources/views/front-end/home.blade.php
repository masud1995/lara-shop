...
<section class="slider_area" id="slider_area"  style="background-color: #f6f6f6;padding-bottom: 10px;">
                                ...
                                <div class="carousel-inner" role="listbox">
                                      @foreach($sliders as $key => $slider)
                                        <div class="item @if($key==0) active @endif">
                                           <a href="#">
                                                <img style="width: 100%;max-height: 300px;" src="{{$slider->img}}" alt="{{$slider->title}}">
                                            </a>
                                        </div>
                                      @endforeach
                                </div>
...
<section class="best_seller_product"  style="background-color: #fff;padding-bottom: 10px" id="main_content_area">
    ...
    <div class="container" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12 mobile-border-of" style="background: #fff;padding: 5px;">
                    <h4 class="cat-title" style="margin-bottom: 5px !important;">প্রোডাক্ট ক্যাটেগরীজ</h4>
                        @foreach($categories as $category)
                          <a href="{{ url('category') }}/{{ $category->name }}/{{ $category->id }}" class="btn btn-success" style="margin: 2px;background: green; font-size: 12px;">{{ $category->name }}</a>
                        @endforeach
                </div>
            </div>

            <div class="row" style="margin-top:20px">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  mobile-border-of" style="background: #CDF6CD;padding: 5px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12" style="background: #CDF6CD;padding: 0px;margin-bottom: 20px;padding-top: 15px  " >
                        <div class="slider">
                              ...
                              @endphp
                               <li class="product">
                                     <a href="product/{{ $hotproduct->id }}/{{ $hotproduct->slug }}">
                                         @if($off != 0)
                                         <span class="percentage-span-new" style="background-image: url({{ asset('image/flash-deal-percentage.png') }}) !important;"><font class="percentage-amount-new">{{ $off }}</font><font class="percentage-sign-new">%</font><font class="percentage-discount-amount-new">ছাড়</font></span>
                                         @endif
                                        <span class="price-text">৳&nbsp; {{ $hotproduct->sprice }}</span>
                                        <img src="{{ asset('/') }}image/product_image/{{ $hotproduct->img1 }}" alt="egbazar.com" title="{{ $hotproduct->title }}"/>
                                    </a>
                                </li>
                              @endforeach
                           </ul>
            ...
            <div class="row" style="margin-top:20px">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  mobile-border-of" style="background: #fff;padding: 5px;">
                    <h4 class="cat-title" style="margin-bottom: 7px !important;"> সাম্প্রতিক প্রোডাক্ট</h4>
                          ...
                          @foreach($products as $product)
                            <div class="col-sm-2 col-xs-6  product-hover-area" style="padding: 0">
                                <div class="col-sm-12 col-xs-12 padding-zero " style="background-color: #fff;padding: 0px;border-bottom: 3px solid #ECECEC;border-right: 3px solid #ECECEC;">
                                    ...
                                    <a  style="padding: 0px;height: 180px;overflow: hidden;" class="img-hover col-sm-12 padding-zero" href="product/{{ $product->id }}/{{ $product->slug }}"  id="1186" >
