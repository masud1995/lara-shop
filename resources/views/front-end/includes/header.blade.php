                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 padding-zero">
                        <div style="float: left">
                            <a href="{{ route('/') }}"><img src="{{ asset('/') }}{{$basic->logo}}" style="float: right" alt="Logo" title="{{$basic->name}}"></a>
                        </div>
                    </div>
                    ...
                    <div style="padding-right:0" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-group" >
                        <ul class="navbar-nav  ">
                            ...
                            <li  data-toggle="modal" data-target="#mySms" class="top-menu-padding" style="padding-top: 20px;padding-left: 0"><a style="background:darkgreen;color: #fff;font-weight: bold;padding-left: 10px;padding-right: 10px;border-radius: 6px;" href="#" title="Track Your Order" class="font-color1">
                                       অর্ডার ট্র্যাকিং
                                </a></li>
                    ...
                    <ul class="main-menu clearfix">
                      <li><a href="{{ url('/') }}">হোম</a></li>
                        ...
                        @foreach($menus as $menu )
                            <li><a href="{{ url('category') }}/{{ $menu->name }}/{{ $menu->id }}" @if($i == $totalmenu) style="border-right:1px solid #fff;" @endif >{{ $menu->name }}
                                <?php
                                ...
                                ?>
                                    ...
                                    <ul class="sub-menu">
                                      @foreach($subctg as $submenu )
                                          <li><a href="{{ url('category') }}/{{ $submenu->name }}/{{ $submenu->id }}">{{ $menu->name }}</a></li>
                                      @endforeach
                                    </ul>
                                </li>
                                <?php
 ...
 <div class="modal fade" id="mySms" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 form-group">
               <input style="width:100% !important;padding: 20px;" required type="number" class="form-control" name="phone" placeholder="Please Type Your Mobile Number">
        </div>

                </div>
                <div class="modal-footer" style="border:0;padding: 50px 30px 30px 30px;">
                    <input style="color:#fff;font-weight:bold;padding: 5px;width:100% !important;background:limegreen"  type="submit" class="btn  pull-right" value="Search">
                </div>
            </div>
        </form>
...
<nav id="menuBar" class="navbar navbar-default lightHeader  " role="navigation" style="height: auto;top:0;background: #081621;" >
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header" >
            ...
            <!--    <i class="fa fa-question-circle" style="color: #fff; font-size: 24px; font-weight: bold; padding-top: 11px;"></i>-->
            <!--</a>-->

            <!--<a href="" style="float: left;">-->
            <!--    <img class="img-responsive" src="{{ asset('/') }}image/manufacturer_logo/m-logo.png" alt="EG Bazar" style="width: 215px;padding-top: 10px;">-->
            <!--</a>-->
            ...
            <a href="{{ url('/cart') }}"  style="float: right;padding-right: 30px;">
                <span class="badge" style="position: absolute;background: red;color: #fff;top: 10px;right: 13px;" id="MtotalCartItems">{{ Cart::content()->count() }}</span>
                <img class="img-responsive" src="{{ asset('/') }}image/manufacturer_logo/cart-icon.png" alt="{{$basic->name}}" style=" padding-top: 8px;width: 38px;;">
             ...
             <form action="#" method="post" class="form" role="search">
                <div class="form-group" >
                    <div class="input-group">
                        <input type="search" id="msearchpro" class="form-control" placeholder="Search Product" style="border-radius: 4px 0 0 4px !important;border-color: limegreen;margin-left: 8px;padding-left: 10px">

                         <span style="color: #fff; background:green; border: 1px;" class="input-group-addon"> &nbsp;<i class="fa fa-search"></i></span>
                    </div>
                </div>
            </form>
        </div>
