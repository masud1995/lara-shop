                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <div class="form-check">
                          ...
                          <input class="form-check-input" name="notify_customer" type="checkbox" @if($info->notify_customer == 1) checked @endif>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <div class="form-check">
                          <label class="form-check-label">
                          <input class="form-check-input" name="notify_admin" type="checkbox" @if($info->notify_admin == 1) checked @endif>
