...
<section class="content">
  ...
  <!-- form start -->
  <form class="form-horizontal" method="POST" action="{{ url('admin/product/save') }}" accept-charset="utf-8" enctype="multipart/form-data">
    @csrf
      <div class="row">
        <div class="col-md-9">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                          <textarea id="long_description" name="long_description" placeholder="Place some text here" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;"></textarea>
                      </div>
                    </div>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="rprice" name="rprice" value="{{ old('rprice') }}" placeholder="Regular Price">
                      </div>
                      <div class="form-group">
                        <label for="sprice">Standard Price <span style="color:red;">*</span></label>
                        <input type="number" class="form-control" id="sprice" name="sprice" value="{{ old('sprice') }}" placeholder="Standard Price">
                      </div>
                  </div>
                  <!-- /.card-body -->
              </div>
